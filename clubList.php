              ...
              <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="addClubAdvisor.php?club_id=<?php echo $token; ?>" class="btn btn-success m-btn btn-sm 	m-btn m-btn--icon">
                        <span>
                          <i class="fa flaticon-add"></i>
                          <span>Add Advisor</span>
                        </span>
                      </a>
                      <a href="addStudent.php?club_id=<?php echo $token; ?>" class="btn btn-info m-btn btn-sm 	m-btn m-btn--icon">
                        <span>
                          <i class="fa flaticon-add"></i>
                          <span>Add Student</span>
                        </span>
                      </a>
                      <a href="editClub.php?id=<?php echo $token; ?>" class="btn btn-warning m-btn btn-sm 	m-btn m-btn--icon">
                        <span>
              ...
              <form action="addClub.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="m-radio-inline">
                    ...
                    <label class="m-radio">
                      <input type="radio" name="club_stat" value="d" select="selected"> Draft
                      <span></span>
                    </label>
                  </div>
                </div>
