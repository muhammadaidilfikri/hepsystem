				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Student's File Management </h3>
							</div>
							<div>
						...
						<div class="m-portlet">
							...
							<div class="m-portlet__body">
								...
								while ($row = mysqli_fetch_array($sql_events1)) {
									...
									$fName = $row['fName'];
									$fNoic = $row['fNoic'];
									$fPosition = $row['fPosition'];
									$fEmployee = $row['fEmployee'];
									$fSalary = $row['fSalary'];

									$mName = $row['mName'];
									$mNoic = $row['mNoic'];
									$mPosition = $row['mPosition'];
					...
					<form action="t6.php" method="post">
						...
						<div class="form-group m-form__group">
							<label for="Name"><b>BOX Number</b> (4 Characters Allowed)</label>
							<input type="text" class="form-control m-input m-input--solid" name="fileNum" id="fileNum" aria-describedby="fileNum" placeholder="(Box number eg A14, B32, C89)">
							<span class="m-form__help"></span>
						</div>
