...
// Validate and sanitize club_id
//$sid = isset($_GET["club_id"]) ? intval($_GET["club_id"]) : 0;
//if($sid <= 0) {
//    die("Invalid club ID");
//}
		...
		<!-- begin::Body -->
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="col-lg-12">
            <?php
						$sql_events2 = mysqli_query($connection, "SELECT * FROM club WHERE token='$sid'") or die(mysqli_error($connection));
						if(mysqli_num_rows($sql_events2) > 0) {
							$row = mysqli_fetch_array($sql_events2);
							$club_id = $row["club_id"];
          ...
          <div class="m-portlet" id="m_portlet">
            ...
            <div class="m-portlet__body">
              <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                ...
                <tbody>
                  <?php
                  $sql_events = mysqli_query($connection, "SELECT * FROM club, club_registration, student WHERE club.club_id=club_registration.club_id AND student.stdNo=club_registration.stdNo AND club_registration.club_id='$sid'") or die(mysqli_error($connection));
                  $z = 1;
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars($noPhone); ?></td>
                    <td><?php echo sumMarks($stdNo); ?></td>
                  </tr>
                  <?php
                    $z++;
                  } // while loop ends properly
                  ?>
                </tbody>
              </table>
            </div>
