          ...
          <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                ...
                <tbody>
                  <?php
                  $sql_events = mysqli_query($connection, "select * from acstaff,jawatanhakiki where jawatanhakiki.jh_code=acstaff.jh_code order by staffID asc  ") or die (mysqli_error());
                  $z =1;
                  ...
                  while ($row = mysqli_fetch_array($sql_events)) {
                    ...
                    $staffID = $row["staffID"];
                    $nokp = $row["nokp"];
                    $jawatanhakiki = $row["jawatanhakiki"];
                    $gred_code = $row["gred_code"];
                    $gred_jenis = $row["gred_jenis"];
                    $telefonhp = $row["telefonhp"];
                    $email = $row["email"];

                    if($gred_jenis=='A' || $gred_jenis=='Z')
                    {
                      $c_stat="Academic";
                    }
                    else
                    {
                      $c_stat="Administration";
                    }
                  ...
                  <tr>
                    ...
                    <td><?php echo $jawatanhakiki ?></td>
                    <td><?php echo $gred_code ?></td>
                    <td><?php echo $telefonhp ?></td>
