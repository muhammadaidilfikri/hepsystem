              ...
              <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo countClubActivity($club_id) ?></td>
                    <td><?php echo countClubActivityA($club_id) ?></td>
                    <td><?php echo countClubActivityB($club_id) ?></td>
                    <td><?php echo countClubStdRegisteredA($club_id) ?></td>
