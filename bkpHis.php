                    ...
                    <div class="m-section">
                      <div class="m-section__content">
                        <table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand">
                          ...
                          <tbody>
                            <?
                            $sql_events = mysqli_query($connection, "select * from student, bkp where student.stdNo=bkp.stdNo and bkp.stdNo='$ssid' ") or die (mysqli_error());
                            $z =1;
                            ...
                            while ($row = mysqli_fetch_array($sql_events)) {
                              ...
                              if($bkp_stat=='p')
                              {
                                $stat = "Permohonan telah di hantar ke HEA";
                              }
                              else if($bkp_stat=='i')
                              {
                                $stat = "Dokumen tidak Lengkap";
                              }
                              else if($bkp_stat=='x')
                              {
                                $stat = "Tidak layak";
