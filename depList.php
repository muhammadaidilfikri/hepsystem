...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>
			CRS | Asasi Department / Unit List
		</title>
              ...
              <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                  <li class="m-portlet__nav-item">
                    <button type="button" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air" data-toggle="modal" data-target="#m_modal_add"><i class="la la-plus"></i> New Department</button>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="addDepartment.php" method="post">
                ...
                <div class="form-group">
                  <label for="dept_acro" class="form-control-label">Department Acronym</label>
                  <input type="text" class="form-control" name="dept_acro" id="dept_acro">
                </div>
            </div>
