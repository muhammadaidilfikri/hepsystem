          ...
          <div class="m-portlet m-portlet--mobile">
              ...
              <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                  <li class="m-portlet__nav-item">
                    <button type="button" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air" data-toggle="modal" data-target="#m_modal_add"><i class="la la-plus"></i> Register New Club</button>
                  </li>
                </ul>
              </div>
            </div>
            <div class="m-portlet__body">
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                ...
                <tbody>
                  <?php
                  $sql_events = mysqli_query($connection, "select * from club order by club_name asc");
                  $z =1;
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="addStudent.php?club_id=<?php echo $club_token ?>" class="btn btn-info m-btn btn-sm 	m-btn m-btn--icon">
                        <span>
                          <i class="fa flaticon-add"></i>
                          <span>Add Student</span>
                        </span>
                      </a>
                      <a href="editRegClub.php?id=<?php echo $club_token ?>" class="btn btn-warning m-btn btn-sm 	m-btn m-btn--icon">
                        <span>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="addRegClub.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <textarea rows="10" class="form-control" name="club_obj" id="club_obj" required></textarea>
                </div>

                <div class="form-group">
                  <label for="club_max" class="form-control-label">Maximum Members (Minimum 50 students)</label>
                  <input type="number" class="form-control" name="club_max" id="club_max" required>
                </div>
                <div class="form-group">
                  <label for="club_name" class="form-control-label">Club Group Whatsapp / Telegram Link</label>
                  <input type="text" class="form-control" name="club_ws" id="club_ws">
                </div>
                <div class="form-group">
                  <label for="message-text" class="form-control-label">Club Status (Will be approved by HEP)</label>
