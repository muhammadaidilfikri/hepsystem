		...
		<!-- begin::Body -->
          ...
          <div class="m-content">
            ...
            <div class="m-portlet">
              ...
              <div class="col m--align-right"><a class="btn btn-primary" href="searchBKP.php" role="button">Search Student</a> <a class="btn btn-warning" href="pendingBKP.php" role="button">Pending List</a> <a class="btn btn-success" href="searchBKP.php" role="button">Approved List</a></div><br>
            <div class="m-portlet">
              <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                  <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                    Approved List (<? echo countBKPApproved() ?>)
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div class="m-section">
                <div class="m-section__content">
                  <table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand">
                    ...
                    <tbody>
                      <?
                      $sql_events = mysqli_query($connection, "select * from student, bkp where student.stdNo=bkp.stdNo and bkp_stat='a'  order by stdName asc ") or die (mysqli_error());
                      $z =1;
