...
// 3 = HEP
// 4 = HEA
$allowedroles = array(3, 4); // HEP and HEA
if (!in_array($_SESSION['roleid'], $allowedroles)) {
    header("Location: logout.php");
}

// AJAX request for semester data
if (isset($_GET['ajax_sem'])) {
    ...
    // Batch fetch total activity marks
    $marksCache = sumMarksBatch($studentNos);

    // Batch fetch total activity involvement count
    $activitiesCache = countStudentInvolvementBatch($studentNos);
...
<head>
    <meta charset="utf-8" />
    <title>CRS | Asasi Student Report</title>
                                ...
                                <div class="m-widget24">
                                    <div class="m-widget24__item">
                                        ...
                                        <div class="progress m-progress--sm">
                                            <div class="progress-bar m--bg-brand" style="width: 78%;"></div>
                                        </div>
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-3">
                                <div class="m-widget24">
                                    <div class="m-widget24__item">
                                        ...
                                        <div class="m--space-10"></div>
                                        <div class="progress m-progress--sm">
                                            <div class="progress-bar m--bg-info" style="width: 84%;"></div>
                                        </div>
                                        <span class="m-widget24__change">Total Registered</span>
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-3">
                                <div class="m-widget24">
                                    <div class="m-widget24__item">
                                        ...
                                        <div class="m--space-10"></div>
                                        <div class="progress m-progress--sm">
                                            <div class="progress-bar m--bg-danger" style="width: 69%;"></div>
                                        </div>
                                        <span class="m-widget24__change">Total Registered</span>
                                        <span class="m-widget24__number">0%</span>
                                    </div>
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-3">
                                <div class="m-widget24">
                                    <div class="m-widget24__item">
                                        ...
                                        <div class="m--space-10"></div>
                                        <div class="progress m-progress--sm">
                                            <div class="progress-bar m--bg-success" style="width: 69%;"></div>
                                        </div>
                                        <span class="m-widget24__change">Total Registered</span>
                                        <span class="m-widget24__number">0%</span>
                                    </div>
                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text">Asasi Students List</h3>
                            </div>
                        </div>
