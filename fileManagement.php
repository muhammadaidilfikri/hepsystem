	...
	<body  class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<!-- begin::Body -->
          ...
          <div class="m-content">
            ...
            <!-- begin section -->
            <h3>Student's File Management</h3>
            <div class="m-portlet">
                      ...
                      <div class="m-widget1__item">
                        <div class="row m-row--no-padding align-items-center">
                          ...
                          <div class="col m--align-right">
                            <span class="m-widget1__number m--font-warning"><? echo countStudent() ?></span>
                          </div>
                        </div>
                      </div>
                      <div class="m-widget1__item">
                        <div class="row m-row--no-padding align-items-center">
                          <div class="col">
                          <h3 class="m-widget1__title">File Created</h3>
                            <span class="m-widget1__desc">Total Box Used</span></div>
                          <div class="col m--align-right"><span class="m-widget1__number m--font-success"><? echo countBox() ?></span></div>
                        </div>
                      </div>
                      <div class="m-widget1__item">
                        <div class="row m-row--no-padding align-items-center">
                          <div class="col">
                            <h3 class="m-widget1__title">Registered Students</h3>
                            <span class="m-widget1__desc">Total registered students</span>
                          </div>
                          <div class="col m--align-right">
                            <span class="m-widget1__number m--font-brand"><? echo countFileNum() ?></span>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-xl-4">
                    ...
                    <div class="m-widget14">
                      <div class="m-widget14__header">
                        ...
                        <span class="m-widget14__desc">
                          between Total Students and Registered Students</span>
                      </div>
                      <div class="row  align-items-center">
                        <div class="col">
                          <div id="ct-chart" class="m-widget14__chart" style="height: 160px">
                            <div class="m-widget14__stat"><? echo countFileNum() ?></div>
                          </div>
                        </div>
                        <div class="col">
                          <div class="m-widget14__legends">
                            <div class="m-widget14__legend">
                              ...
                              <span class="m-widget14__legend-text"><? echo round( countFileNum()/totalStudent()*100,2)?>% Registered </span>
                            </div>
              ...
              <div class="col m--align-right"><a class="btn btn-primary" href="searchFileBox.php" role="button">Add File Box</a></div><br>
            <div class="m-portlet">
              <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                  <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                      File Management List (Recently Submitted)
                    </h3>
                  </div>
                </div>
              </div>
                  ...
                  <table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><? echo $fileNum ?></td>
                        <td><? echo countStdFile($fileNum) ?></td>
