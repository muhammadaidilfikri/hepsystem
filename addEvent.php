...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>AsidApps - Event Calendar</title>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<form action="createEvent.php" method="post">
						...
						<div class="form-group m-form__group">
							...
							<input type="text" class="form-control m-input m-input--solid" name="eventname" id="fileNum" aria-describedby="fileNum" placeholder="Name of the event">
						...
						<div class="form-group m-form__group">
							...
							<div class="col-lg-4 col-md-9 col-sm-12">
								<div class="input-group date">
									<input type="text" name="date_start" class="form-control m-input" readonly placeholder="Select date" id="m_datepicker_2" data-date-format="yyyy-m-d" />
						...
						<div class="form-group m-form__group">
							...
							<div class="col-lg-4 col-md-9 col-sm-12">
								<div class="input-group date">
									<input type="text" name="date_end" class="form-control m-input" readonly placeholder="Select date" id="m_datepicker_2"  data-date-format="yyyy-m-d" />
									<div class="input-group-append">
										<span class="input-group-text">
											<i class="la la-calendar-check-o"></i>
										</span>
				...
				<br><br>
					<div class="m-portlet__foot " align="center">
						...
						<div class="m-form__actions">
							<a href="addEvent.php" class="btn btn-secondary">Reset </a>
