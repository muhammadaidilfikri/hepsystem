              ...
              <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                  <li class="m-portlet__nav-item">
                    <button type="button" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air" data-toggle="modal" data-target="#m_modal_add"><i class="la la-plus"></i> New Record</button>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><? echo $c_stat ?></td>
                      <td><? echo $club_max ?></td>
                    <td>
                      <a href="editClub.php?id=<? echo $club_id ?>" class="btn btn-warning m-btn btn-sm 	m-btn m-btn--icon">
                        <span>
                          <i class="fa flaticon-edit"></i>
                          <span>Edit</span>
                        </span>
                      </a>
                      <a href="deleteClub.php?id=<? echo $club_id ?>" class="btn btn-danger m-btn btn-sm 	m-btn m-btn--icon">
                        <span>
