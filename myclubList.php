          ...
          <div class="m-portlet m-portlet--mobile">
              ...
              <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                  <h3 class="m-portlet__head-text">
                    Co-curricular Club List (Active Clubs)
                  </h3>
                </div>
              </div>
            ...
            <div class="m-portlet__body">
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                ...
                <tbody>
                  <?php
                  $sql_events = mysqli_query($connection, "select * from club,club_advisor where club.club_id=club_advisor.club_id and club_advisor.staffID='$_SESSION[username]'  and club_stat='e' order by club_name asc  ") or die (mysqli_error());
                  $z =1;
