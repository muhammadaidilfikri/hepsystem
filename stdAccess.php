		...
		<!-- begin::Body -->
          ...
          <div class="m-content">
            ...
            <!--begin:: Widgets/Stats-->
              ...
              <!--Begin::Section-->
              <!--begin:: Widgets/Stats-->
        <h3>Student Access (In / Out Campuses)</h3>
              <div class="m-portlet ">
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-3">
                      ...
                      <div class="m-widget24">
                        <div class="m-widget24__item">
                          ...
                          <br>
                          <span class="m-widget24__desc">
                            Total student go out today
                          </span>
                          <span class="m-widget24__stats m--font-info">
                            <? countStudentOutToday();?>
                          </span>
                          <div class="m--space-10"></div>
                          <div class="progress m-progress--sm">
            ...
            <!-- begin section -->
              ...
              <div class="col m--align-right"><a class="btn btn-primary" href="searchStudentIO.php" role="button">Student Access In / Out Log</a></div><br>
            <div class="m-portlet">
              <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                  <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                      Today's Record (<?echo $today ?>) Top 10
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div class="m-section">
                <div class="m-section__content">
                  <table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand">
                    ...
                    <tbody>
                      <?
                      $sql_events = mysqli_query($connection, "select * from stdaccess, student,bkp where bkp.stdNo=student.stdNo and  student.stdNo=stdaccess.stdNo ") or die (mysqli_error());
                      $z =1;
                      ...
                      while ($row = mysqli_fetch_array($sql_events)) {
                        ...
                        if ($date->format('Y-m-d')==$date_today){

                      ?>
                      <tr>
                        <th scope="row"><? echo $z ?></th>
                        <td><a href="studentProfile.php?vid=<? echo $stdNo ?>"><? echo $stdNo ?></a></td>
                        <td><? echo $stdName ?></td>
                        <td><? echo stdTimeOut($stdNo); ?></td>
                        <td><? checkstdAccess($stdNo) ?></td>
                        <td></td>
                      </tr>
                      <?
                      $z++;
