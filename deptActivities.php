  ...
  stroke: #F3C200;
	...
	<body  class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<!-- begin::Body -->
          ...
          <div class="m-portlet m-portlet--mobile">
		    ...
		    <th>Created By </th>
                ...
                <tbody>
                  <?php
                  $sql_events = mysqli_query($connection, "select * from dept,dept_activities where dept.dept_id=dept_activities.dept_id ") or die (mysqli_error());
                  $z =1;
                  $resultSearch = "";
                  $regError = 0;
		    ...
		    else if ($level_id==10)
		    {
		      ...
		      <td><?php echo $dept_name ?></td>
	              <td> <?php echo $addedBy ?> </td>
                    ...
                    <td>
                      <a href="editActivityDeptMod.php?dact_id=<?php echo $dact_id ?>" class="btn btn-warning m-btn btn-sm 	m-btn m-btn--icon">
                        <span>
                          <i class="fa flaticon-edit-1"></i>
                          <span>Edit</span>
                        </span>
                      </a>
                      <a href="deleteDeptActivity.php?dact_id=<?php echo $dact_id ?>" class="btn btn-danger m-btn btn-sm 	m-btn m-btn--icon">
                        <span>
                          <i class="fa flaticon-edit-1"></i>
                          <span>Delete</span>
                        </span>
      ...
      <div class="modal fade" id="m_modal_add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <div class="form-group">
                    						<label for="Name"><b>Organized By</b></label>
                    							...
                    							<select class="custom-select form-control" name="dept_id">
                    								...
                    								<?php
                    								$sql_events1 = mysqli_query($connection, "select * from dept order by dept_name ") or die (mysqli_error());
		...
		<label class="m-radio">
		<input type="radio" name="level_id" value="10">Bicara Interaktif Siswa 
		<span></span>
		</label>
		  </div>
                </div>
                ...
                <div class="m-radio-inline">
                    <label class="m-radio">
                      <input type="radio" name="dept_stat" value="p" checked /> Pending Approval
                      <span></span>
                    </label>
                    <label class="m-radio">
                      <input type="radio" name="dept_stat" value="a" /> Approved
                      <span></span>
                    </label>
                    <label class="m-radio">
                      <input type="radio" name="dept_stat" value="r" /> Rejected
                      <span></span>
                    </label>
                    <label class="m-radio">
                      <input type="radio" name="dept_stat" value="x" /> Postponed
                      <span></span>
                    </label>
                </div>
                </div>
