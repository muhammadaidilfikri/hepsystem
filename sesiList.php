          ...
          <div class="m-portlet m-portlet--mobile">
              ...
              <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                  <li class="m-portlet__nav-item">
                    <button type="button" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air" data-toggle="modal" data-target="#m_modal_add"><i class="la la-plus"></i> New Session</button>
                  </li>
                </ul>
              </div>
            </div>
            <div class="m-portlet__body">
              ...
              <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                ...
                <tbody>
                  <?php
                  $sql_events = mysqli_query($connection, "select * from sesi order by sesi_id desc  ") or die (mysqli_error());
                  $z =1;
                  ...
                  <tr>
                    ...
                    <td><?php echo $sesi_name ?></td>
                    <td><?php echo $sesi_intake ?></td>

                    <td>

                      <a href="editSession.php?sesi_id=<?php echo $sesi_id ?>" class="btn btn-warning m-btn btn-sm 	m-btn m-btn--icon">
                        <span>
            ...
            <div class="modal-body">
              <form action="addSession.php" method="post">
                <div class="form-group">
                  <label for="sesi_name" class="form-control-label">Session Name</label>
                  <input type="text" class="form-control" name="sesi_name" id="sesi_name">
                </div>
                <div class="form-group">
                  <label for="sesi_intake" class="form-control-label">Student Intake</label>
                  <input type="text" class="form-control" name="sesi_intake" id="sesi_intake">
                </div>
            </div>
