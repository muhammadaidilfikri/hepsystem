		...
		<!-- begin::Body -->
            ...
            ?>
              ...
              $act_name = $row["act_name"];
							...
							?>
							<input type="hidden" id="act_id" name="act_id" value="<? echo $sid ?>">
              	<input type="hidden" id="regpoint" name="regpoint" value="<? echo $regpoint ?>">
							<h4><? echo $act_name ?> </h4>
              <span class="m--font-primary">Organized by : <? echo $club_name ?></span>
              <br><br>
  ...
  <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><? echo $regs ?></td>
        <td>
          <a href="deleteRegStudent.php?actreg_id=<? echo $actreg_id ?>&amp;act_id=<? echo $act_id ?>&amp;regpoint=<? echo $regpoint ?>" class="btn btn-danger m-btn btn-sm 	m-btn m-btn--icon">
            <span>
