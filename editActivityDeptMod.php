			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<form action="updateActivityDeptMod.php" method="post">
						...
						$sql_events = mysqli_query($connection, "select * from dept,dept_activities,kew  where kew.kew_id=dept_activities.kew_id and dept.dept_id=dept_activities.dept_id   and dept_activities.dact_id='$dact_ida'") or die (mysqli_error());
					...
					<div class="m-radio-inline">
							<label class="m-radio">
								<input type="radio" name="dept_stat" value="p" <?php if($dept_stat=="p") echo " checked " ?> /> Pending Approval
								<span></span>
							</label>
							<label class="m-radio">
								<input type="radio" name="dept_stat" value="a" <?php if($dept_stat=="a") echo " checked " ?> /> Approved
								<span></span>
							</label>
							<label class="m-radio">
								<input type="radio" name="dept_stat" value="r" <?php if($dept_stat=="r") echo " checked " ?> /> Rejected
								<span></span>
							</label>
							<label class="m-radio">
								<input type="radio" name="dept_stat" value="x" <?php if($dept_stat=="x") echo " checked " ?> /> Postponed
								<span></span>
							</label>
					</div>
					</div>
					...
					<div class="m-portlet__foot " align="center">
						...
						<div class="m-form__actions">
							<a href="deptActivities.php" class="btn btn-secondary">Reset </a>
