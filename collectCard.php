...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>AsidApps - Management</title>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Smart Card - Card's Collection </h3>
							</div>
							<div>
								...
								<form action="t10.php" method="post">
										<div class="m-portlet__foot " align="center">
											...
											<div class="m-form__actions">
												<button type="submit" class="btn btn-success">Register for Card Collection</button>
											</div>
										</div>
									</form>
