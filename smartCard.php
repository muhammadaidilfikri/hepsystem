                    ...
                    <div class="m-widget1">
                      <div class="m-widget1__item">
                        <div class="row m-row--no-padding align-items-center">
                          <div class="col">
                          <h3 class="m-widget1__title">Students</h3>
                            <span class="m-widget1__desc">Total Registered</span>
                          </div>
                          <div class="col m--align-right">
                            <span class="m-widget1__number m--font-warning"><?  countCard() ?></span>
                          </div>
                        </div>
                      </div>
                      <div class="m-widget1__item">
                        <div class="row m-row--no-padding align-items-center">
                          ...
                          <h3 class="m-widget1__title">Pending</h3>
                            <span class="m-widget1__desc">Total cards pending</span></div>
                          <div class="col m--align-right"><span class="m-widget1__number m--font-success"><?  countCardPending() ?></span></div>
                        </div>
                      </div>
                      <div class="m-widget1__item">
                        <div class="row m-row--no-padding align-items-center">
                          <div class="col">
                            <h3 class="m-widget1__title">Collected</h3>
                            <span class="m-widget1__desc">Total cards collected</span></span>

                          </div>
                          <div class="col m--align-right">
                            <span class="m-widget1__number m--font-danger"><?  countCardCollected() ?></span>
                          </div>
                        </div>
                      </div>
                    </div>
