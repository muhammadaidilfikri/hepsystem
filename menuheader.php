...
while ($row = mysqli_fetch_array($sql_events)) {
	...
	//$nama = $row["nama"];
	$nama = $gelaran.$fullname;


	$staffID = $row["staffID"];
  $pic1 = "https://eproses.uitm.edu.my/mye/eKiosk/image_staf_view_act.cfm?UiTMID=" .$staffID;
	$pic2 = "images/user.png";
	$email = $row["email"];

	if (strpos($pic1, 'jpg') == false) {
	    $pic  = $pic2;
	}
	else {
		$pic = $pic1;
						...
						<div class="m-stack__item m-brand  m-brand--skin-dark ">
							<div class="m-stack m-stack--ver m-stack--general">
								<div class="m-stack__item m-stack__item--middle m-brand__logo">
									<a href="main.php" class="m-brand__logo-wrapper">
											...
											<div class="m-dropdown__wrapper">
												...
												<div class="m-dropdown__inner ">
													<div class="m-dropdown__header">
														<form  class="m-list-search__form" action="studentProfile.php" method="post" id="studentProfile">
															<div class="m-list-search__form-wrapper">
																<span class="m-list-search__form-input-wrapper">
																	<input id="stdVi" autocomplete="off" type="text" name="stdVi" class="m-list-search__form-input" value="" placeholder="Search..." autofocus >
																</span>
										...
										<li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
											<a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
													<img src="<?php echo $pic ?>" class="m--img-rounded m--marginless m--img-centered" alt=""/>
												</span>
													...
													<div class="m-dropdown__header m--align-center" style="background: url(images/user_profile_bg.png); background-size: cover;">
														<div class="m-card-user m-card-user--skin-dark">
															<div class="m-card-user__pic">
																<img src="<?php echo $pic ?>" class="m--img-rounded m--marginless" alt=""/>
															</div>
															<div class="m-card-user__details">
																<span class="m-card-user__name m--font-weight-500">
																	<?php echo $nama ?> <br>(<?php echo $staffID ?>)
																</span>
