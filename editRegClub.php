				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Edit Club Registrations </h3>
							</div>
							<div>
					...
					<form action="updateClub.php" method="post">
						...
						// 	$club_obj = $row["club_obj"];
              			// 	$club_ws = $row["club_ws"];
						// 	}
						$sql = "SELECT club_id, club_name, club_max, club_stat, club_obj, club_ws FROM club WHERE token = ?";
                  ...
                  <span class="m-form__help"></span>
					...
					<div class="m-portlet__foot " align="center">
						<div class="m-form__actions">
							<button type="submit" class="btn btn-warning">Update Club Registrations</button>
						</div>
					</div>
				</form>
				</div>
